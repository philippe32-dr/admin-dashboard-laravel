...
@section('header_title', 'Ajouter un abonnement')
...
<div class="container mx-auto">
    ...
    <div class="card max-w-2xl mx-auto">
        <h2 class="text-xl font-semibold text-dark mb-6">Ajouter un nouvel abonnement</h2>
        ...
        <form action="{{ route('admin.subscriptions.add') }}" method="POST">
            @csrf
            ...
            <div class="mb-6">
                ...
                <input type="date" name="expiry_date" id="expiry_date" value="{{ old('expiry_date') }}" class="form-input" required>
            </div>
